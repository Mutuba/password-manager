...
class EncryptionService
  ...
  class << self
    def encrypt_data(data:, encryption_key:)
      ...
      encode_encrypted_data(isolation_vector, encrypted_data, auth_tag)
    ...
    def initialize_cipher(mode, encryption_key, isolation_vector = nil, auth_tag = nil)
    ...
    def encode_encrypted_data(isolation_vector, encrypted_data, auth_tag)
      [isolation_vector, encrypted_data, auth_tag].map { |v| Base64.encode64(v) }.join("--")
    end
    ...
    def decode_encrypted_data(encrypted_data)
    ...
    def decode_and_validate_key(key)
